...
class Application(tk.Tk):
    ...
    def createWidgets(self):
        ...
        self.keyvar.set('关键字')
        items = ['BufferPool', 'Close', 'Data Capture', 'Compress', 'Pqty',
                 'Sqty']
        ...
        gcombobox = ttk.Combobox(topframe, values=items,
        ...
        self.textbox = tk.Text(contentframe, yscrollcommand=rightbar.set,
                               xscrollcommand=bottombar.set)
        # -- 放置位置
